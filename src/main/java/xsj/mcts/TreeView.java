...
public class TreeView extends JComponent {
    private static final long serialVersionUID = -8584087271831037986L;
    ...
    private void drawNode(Graphics2D g,
        ...
        Rectangle2D rect = fm.getStringBounds(s,
                                              g);
        g.drawString(s,
    ...
    public Dimension getPreferredSize() {
        ...
        return new Dimension(minWidth,
                             heightPerLevel * (10 - 1) + inset * 2);
    }
